const ColorScale = ({
...
}:{width?:number,height?:number,min?:number,max?:number})=>{
    ...
    return <div className="flex items-center gap-3">
        ...
        <div className="rounded border border-stone-500" style={{width:`${width}px`,height:`${height}px`,background:gradient}}/>
