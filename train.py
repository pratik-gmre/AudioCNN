...
# Define the image with required dependencies and setup commands
image = (
...
# Define volumes for storing data and models
...
# Define the remote train function
@app.function(
    image=image,
    gpu="A10G",
...
def train():
    ...
    for epoch in range(num_epochs):
        ...
        print(
            f"Epoch {epoch+1} loss: {avg_epoch_loss:.4f} accuracy: {accuracy:.4f}% val_loss: {avg_val_loss:.4f}"
        )
